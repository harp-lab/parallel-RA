...
lie->add_scc_dependance(scc5009, scc4998);
  ...
  // Enable IO
 //lie->enable_share_io();
 //lie->set_output_dir(../data/worstcase-110-terms-6-m-output); // Write to this directory
 //lie->enable_share_io();
 lie->set_comm(mcomm);
