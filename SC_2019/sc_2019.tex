...
In this paper we present a set of efficient algorithms to effectively parallelize key relational algebra primitives. We introduce an hash-tree approach to  
Finally we demonstrate the scalibility of our relational algebra primitives through the fixed point algorithm that computes the transitive closure of a large graph at scale.
\end{abstract}
