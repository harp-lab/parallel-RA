...
Finally we demonstrate the scalibility of our implementation through the fixed point algorithm that computes the transitive closure of a large graph at scale.
\end{abstract}
