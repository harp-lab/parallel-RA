...
struct google_relation {
    ...
    void as_all_to_all_join_buffer(std::vector<u64> prefix, all_to_all_buffer& join_buffer, u64 *input0_buffer, int input0_buffer_width, int ra_id, u32 buckets, u32* output_sub_bucket_count, u32** output_sub_bucket_rank, std::vector<int> reorder_map, int projection_column_count, int join_column_count, google_relation& deduplicate, u32* local_join_duplicates, u32* local_join_inserts);

    void as_all_to_all_join_buffer_helper(google_relation*& cur_trie, std::vector<u64> cur_path, all_to_all_buffer& join_buffer, u64 *input0_buffer, int input0_buffer_width, int ra_id, u32 buckets, u32* output_sub_bucket_count, u32** output_sub_bucket_rank, std::vector<int> reorder_map, int projection_column_count, int join_column_count, google_relation& deduplicate, u32* local_join_duplicates, u32* local_join_inserts);
